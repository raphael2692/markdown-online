...
Statuses: `todo | built | live`. Keep this file updated as pages ship — copy it into the project repo on first use (e.g. `docs/keyword-map.md`) so it's versioned with the site; this bundled copy is just the seed.
...
| markdown-to-html | markdown to html | md to html converter | devs embedding content | todo |
